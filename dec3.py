...
# In the third position, there are an equal number of 0 bits and 1 bits (one each). So,
# to find the CO2 scrubber rating, keep the number with a 0 in that position: 01010.
