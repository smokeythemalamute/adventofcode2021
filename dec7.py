...
# to get through. However, it doesn't look like they'll be
# aligned before the whale catches you! Maybe you can help?
#
# There's one major catch - crab submarines can only move
# horizontally.
#
# You quickly make a list of the horizontal position of each
# crab (your puzzle input). Crab submarines have limited fuel,
...
#
# This means there's a crab with horizontal position 16, a crab
# with horizontal position 1, and so on.
#
# Each change of 1 step in horizontal position of a single crab
# costs 1 fuel. You could choose any horizontal position to
# align them all on, but the one that costs the least fuel is
...
# outcome; more expensive outcomes include aligning at position
...
# This changes the best horizontal position to align them all
...
def cost_lin(curr: int, dest: int) -> int:
    # Shortcut: https://en.wikipedia.org/wiki/Summation
    #
    #     n
    #   \---     n (n + 1)
    #    >   i = ---------
